...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="
        cn(
          'bg-body data-[state=open]:animate-in data-[state=closed]:animate-out shadow-floating fixed z-50 flex flex-col gap-4 rounded-l-lg p-4 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-300',
          side === 'right' &&
