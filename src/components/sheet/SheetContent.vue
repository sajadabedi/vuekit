...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="
        cn(
          'bg-body data-[state=open]:animate-in data-[state=closed]:animate-out shadow-floating fixed z-50 flex flex-col gap-4 p-4 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
          side === 'right' &&
